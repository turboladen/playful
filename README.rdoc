...
Playful::SSDP::Searcher receives and parses responses, it adds them to the accessor
...
Playful::ControlPoint::Device objects so you can control your device) as you
receive them.
...
interested in using a Playful::ControlPoint, instead of doing all that work (above)
to create a Playful::ControlPoint::Device.  The ControlPoint will handle doing the
